"""Export-time package markers for the generated ``assets/scripts/`` tree.
...
``from assets.scripts.<page>.<window> import …`` resolves on any
Python. ``write_package_markers_in`` seeds those markers into the
build output. Pure I/O: no UI, no Tk.
"""
